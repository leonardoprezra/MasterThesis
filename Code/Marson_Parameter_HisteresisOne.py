...
settings['outputInterval_gsd'] = 7500
# Number of time steps between data storage in log file
settings['outputInterval_log'] = 5
settings['equil_steps'] = 7500  # Number of equilibration steps
settings['ratio'] = 1
...
for initDict in parameterspace:
    ...
    proc = subprocess.Popen(["python",  "-u",
                             # "MarsonNVE.py",  #
                             "/home/hpc/iwsp/iwsp023h/MasterThesis/Code/MarsonNVEHisteresisOne.py",
                             *initString],
                            stdout=out,
                            stderr=out)
    proc.wait()
