...
for initDict in parameterspace:
    ...
    proc = subprocess.Popen(["python",  "-u",
                             # "MarsonNVE.py",  #
                             "/home/hpc/iwsp/iwsp023h/MasterThesis/Code/MarsonNVEHisteresisClusters3D.py",
                             # "/nishome/students/leonardo/Dokumente/Thesis/Code/MarsonNVEHisteresisClusters3D.py",
                             # "/home/leo/MasterThesis/Code/MarsonNVEHisteresisClusters3D.py",
                             *initString],
                            stdout=out,
                            stderr=out)
    proc.wait()
