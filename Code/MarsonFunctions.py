...
settings['diameter'] = 1.0  # Outer diameter of cluster
...
settings['N_cluster'] = 38  # number of spheres in cluster
...
settings['equil_steps'] = 500  # Number of equilibration steps

settings['outputInterval_gsd'] = 500 # Number of time steps between data storage in gsd file
settings['outputInterval_log'] = 50 # Number of time steps between data storage in log file
